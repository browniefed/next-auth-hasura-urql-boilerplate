...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    FindUserFromEmail(variables: FindUserFromEmailQueryVariables): Promise<FindUserFromEmailQuery> {
      return withWrapper(() => client.request<FindUserFromEmailQuery>(print(FindUserFromEmailDocument), variables));
    }
  };
}
